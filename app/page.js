...
export default function Home() {
  return (
    <section className="w-full bg-black text-[white] flex items-center justify-center h-5/6">
      <div className="flex flex-col gap-4 justify-center items-center px-2 mb-20">
        <div className="space-y-4 text-center">
          ...
          <p className="max-w-[600px] mx-auto text-[#FAFAFA] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
