...
const Loader = () => {
  return (
    <div className="absolute z-50 top-0 left-0 h-screen w-screen overflow-hidden bg-black flex flex-col gap-6 items-center justify-center">
      <div
        className="inline-block h-20 w-20 animate-spin rounded-full border-4 border-white border-current border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite]"
        role="status"
      >
